...
const API = 'https://mateweb-production.up.railway.app/'
  ...
  return (
    <>
                      ...
                      {editando === a.id_año_escolar ? (
                        <>
                          <CButton
                            ...
                            size="sm"
                            className="me-2"
                            onClick={() => guardarEdicion(a.id_año_escolar)}
                          >
                            Guardar
                          </CButton>
                          <CButton
                        ...
                        <>
                          <CButton
                            ...
                            size="sm"
                            className="me-2"
                            onClick={() => iniciarEdicion(a.id_año_escolar, a.nombre)}
                          >
                            Editar
                          </CButton>
                          <CButton
                            ...
                            size="sm"
                            variant="outline"
                            onClick={() => confirmarEliminar(a.id_año_escolar)}
                          >
                            Eliminar
                          </CButton>
                        </>
      ...
      <CModal visible={modalEliminar} onClose={() => setModalEliminar(false)}>
        ...
        <CModalBody>¿Seguro que deseas eliminar este año escolar?</CModalBody>
        <CModalFooter>
          <CButton
            style={{ backgroundColor: 'white', color: 'red', borderColor: 'red' }}
        ...
        <CCardBody>
          <CForm onSubmit={handleSubmit}>
            ...
            <div className="d-grid">
              <CButton style={{ backgroundColor: '#114c5f', color: 'white' }} type="submit">
                Crear
              </CButton>
            </div>
          </CForm>
